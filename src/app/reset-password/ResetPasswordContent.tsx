...
export default function ResetPasswordContent({ token: initialToken }: ResetPasswordContentProps) {
  ...
  // Check if token is valid on mount (if no token, show error immediately)
